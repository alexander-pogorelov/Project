         ...
         <?php else: ?>
             ...
             <div class="blocks">
                 ...
                 <form action="#" method="POST">
					...
					<p class="line"><span>Phone:</span> <input type="text" placeholder="Введите Ваш телефон" title="<?php echo 'Используйте только цифры. Не менее '.PHONE_MIN.' символов.';?>" name="user[phone]" value="<?php if (isset ($data['user']['phone'])) echo $data['user']['phone'];?>" /></p>
